classdef projectAndReshape_posNormWeights_Layer_fixed < nnet.layer.Layer
    ...
    methods
        function layer = projectAndReshape_posNormWeights_Layer_fixed(outputSize, numChannels, name, weights)
