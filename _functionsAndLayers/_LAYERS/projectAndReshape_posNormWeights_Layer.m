classdef projectAndReshape_posNormWeights_Layer < nnet.layer.Layer
    ...
    methods
        function layer = projectAndReshape_posNormWeights_Layer(outputSize, numChannels, name, weights)
