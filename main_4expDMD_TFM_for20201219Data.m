...
% [Xhat_wlPr FitInfo] = f_rec_inv_wlPrior_lasso (pram,E,Yhat,gamma,wname);        % wavelet-prior matlab lasso
[Xhat_wlPr FitInfo]   = f_rec_inv_wlPrior_lasso (pram,E,Yhat,gamma,wname,0.005);  % wavelet-prior matlab lasso
...
%% save plot
saveas(gcf,[savepath fileNameStem 'animal2_r2_400um_fig.jpeg']);  
close all
